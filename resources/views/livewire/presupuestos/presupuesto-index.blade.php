<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Presupuestos') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Gestiona todos tus presupuestos') }}</flux:subheading>
                ...
                <tbody>
                    @foreach ($presupuestos as $presupuesto)
                        <tr
                            ...
                            <td class="px-6 py-2 font-medium text-gray-900 dark:text-white">{{ $presupuesto->id }}</td>
                            ...
                            <td class="px-6 py-2 text-gray-600 dark:text-gray-300">{{ number_format($presupuesto->monto, 2) }}</td>
                            <td class="px-6 py-2">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    @endcan
                                    @can('presupuesto.delete')
                                        <button wire:click="delete({{ $presupuesto->id }})" wire:confirm="¿Estás seguro que deseas eliminar este presupuesto?"
