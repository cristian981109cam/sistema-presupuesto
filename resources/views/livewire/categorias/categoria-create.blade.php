<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Crear Categoria') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Formulario para crear nueva categoria') }}</flux:subheading>
